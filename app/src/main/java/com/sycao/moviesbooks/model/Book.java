package com.sycao.moviesbooks.model;

import java.util.List;

/**
 * Created by sycao on 2017/5/17.
 * 豆瓣图书实体类
 */
...
public class Book {
    ...
    /**
     * rating : {"max":10,"numRaters":361,"average":"7.1","min":0}
     * subtitle :
     * author : ["[日] 片山恭一"]
     * pubdate : 2005-1
     * tags : [{"count":142,"name":"片山恭一","title":"片山恭一"},{"count":68,"name":"日本","title":"日本"},{"count":64,"name":"日本文学","title":"日本文学"},{"count":40,"name":"小说","title":"小说"},{"count":33,"name":"满月之夜白鲸现","title":"满月之夜白鲸现"},{"count":15,"name":"爱情","title":"爱情"},{"count":9,"name":"純愛","title":"純愛"},{"count":8,"name":"外国文学","title":"外国文学"}]
     * origin_title :
